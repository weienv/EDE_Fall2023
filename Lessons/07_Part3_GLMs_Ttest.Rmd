...
O3.onesample #p-value:  less than 0.05 --> reject null hypothesis
#pop mean >= 50
...
O3.twosample #reject null --> the means are different

# Format as a GLM
# changing the quesiton to: is year a good predictor of ozone?
